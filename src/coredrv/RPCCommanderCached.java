...
public class RPCCommanderCached extends RPCCommander {
    ...
    @Override synchronized public StringResponse sendToAddress(String address, long amount, String sms, String sender) {
        StringResponse res=super.sendToAddress(address,amount,sms,sender);
        if(res.isOk()) cacheStatus.data=null;
        return res;
    }
